...
namespace LulukaBankIdentityProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20230818163828_mig_customeraccounttransaction_add_description")]
    partial class mig_customeraccounttransaction_add_description
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LulukaBankIdentityProject.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LulukaBankIdentityProject.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LulukaBankIdentityProject.EntityLayer.Concrete.CustomerAccount", b =>
                {
                    b.HasOne("LulukaBankIdentityProject.EntityLayer.Concrete.AppUser", "AppUser")
            ...
            modelBuilder.Entity("LulukaBankIdentityProject.EntityLayer.Concrete.CustomerAccountTransaction", b =>
                {
                    b.HasOne("LulukaBankIdentityProject.EntityLayer.Concrete.CustomerAccount", "ReceiverCustomer")
                        .WithMany("CustomerReceiver")
                        .HasForeignKey("ReceiverID");

                    b.HasOne("LulukaBankIdentityProject.EntityLayer.Concrete.CustomerAccount", "SenderCustomer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("LulukaBankIdentityProject.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("LulukaBankIdentityProject.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
